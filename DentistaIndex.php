...
<body>
  ...
  <div class="container my-3">
    <div class="row">
      <h1 class=" font-weight-bold mr-5 col-9">Pacientes cadastrados</h1> 
      <a class="btn btn-warning float-right my-auto text-dark font-weight-bold" href="DentistaIndex.php" role="button">Cadastrar Paciente</a>
    </div>
  </div>
  <hr>
    ...
    <div class="table-responsive my-3">
      <table id="example" class="table table-bordered">
        ...
        <tbody>
            ...
            $Listar = new DentistaDAO();
            $Listar->VerificarPacientes();
            ?>
