 ...
 <nav class="navbar navbar-light" style="background-color: black;"> <!-- navbar-expand-lg -->
  ...
  <div class="container"> 
    ...
    <ul class="nav nav-tabs">
      ...
      <li class="nav-item">
        <?php
        echo "<a class='nav-link active' href='Necessidade.php?nome=".$_GET['nome']."&id=".$_GET['id']."'>Necessidade(s)</a>";
        ?>
      </li>
      <li class="nav-item">
        <?php
...
<div class="container ">  
 <h1 class="display-5 my-3">Necessidade(s) do paciente</h1>

 <form action="SQLChange/NecessidadeTratamentoRecebe.php" method="post"> 
   <?php 
